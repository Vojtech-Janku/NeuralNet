...
### USER GUIDE
- the model is created, trained and used for predictions in the main function in neural_net.cpp, you can play around with hyperparameters there
- compile and run the programme by running "bash run.sh"
- the programme outputs two files to the data directory:
